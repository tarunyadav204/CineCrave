            ...
            <div className='group grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
                {dummyTrailers.map((trailer) => (
                    <div
                        ...
                        className='relative group-hover:not-hover:opacity-50 hover:opacity-100 hover:-translate-y-1 duration-300 transition max-md:h-60 md:max-h-60 cursor-pointer'
                    >
                        <img
                            src={trailer.image}
                            alt='trailer'
