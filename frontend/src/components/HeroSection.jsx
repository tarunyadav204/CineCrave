...
const HeroSection = () => {
    ...
    return (
        ...
        bg-cover bg-center h-screen'>
            ...
            <p className='max-w-md text-gray-300' >ln a post-apocalyptic world where
                cities ride on wheels and consume each other to survive, two people meet in
                London and try to stop a conspiracy </p>
            <button onClick={() => navigate("/movies")} className='flex items-center gap-I px-6 py-3 text-sm bg-primary
