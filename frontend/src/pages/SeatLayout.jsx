...
const SeatLayout = () => {
    ...
    const handleSeatClick = (seatId)=>{
      ...
      /*  if(selectedSeats.includes(seatId)){
            selectedSeats.filter((seatId)=> seatId !== seatId);
        }*/
    ...
    if (!timings) return <p className="text-center text-red-500 mt-10">Invalid or missing date</p>;
        ...
        <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
            ...
            <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
                ...
                <div className='flex flex-col items-center mt-10 text-xs text-gray-300'>
                    {/* First group of rows rendered in a grid */}
                    <div className='grid grid-cols-2 md:grid-cols-1 gap-2 md:gap-2 mb-6'>
                        {groupRows[0].map(row => renderSeats(row))}
                    </div>

                    {/* Remaining groups rendered in a nested grid */}
